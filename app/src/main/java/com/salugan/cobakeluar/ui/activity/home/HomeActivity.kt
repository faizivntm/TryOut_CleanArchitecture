...
import com.salugan.cobakeluar.core.ui.BannerAdapter
...
class HomeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.iconFAQ.setOnClickListener({
            val intent =
                Intent(Intent.ACTION_VIEW, Uri.parse("https://www.eurekaedutech.com/contact"))
            startActivity(intent)
        })
        binding.btnAbout.setOnClickListener({
            val intent =
                Intent(Intent.ACTION_VIEW, Uri.parse("https://www.eurekaedutech.com/about"))
            startActivity(intent)
        })
    ...
    override fun onBackPressed() {
        ...
        mAuth.signOut()
        val intent =
            Intent(this, ActivityLogin::class.java) // Replace with the appropriate activity
        startActivity(intent)
        finish()
    }
}
